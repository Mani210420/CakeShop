...
namespace CakeShopTests.TagHelpers
{
    public class EmailTagHelperTests
    {
        ...
        public void Generates_Email_Link()
        {
            ...
            Assert.Equal("mailto:info@@CakeShop.com", tagHelperOutput.Attributes[0].Value);
        }
    }
}
